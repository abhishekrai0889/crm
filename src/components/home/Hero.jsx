  ...
  return (
    <section className="relative overflow-hidden bg-white py-24">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute -left-40 top-20 h-105 w-105 rounded-full bg-blue-100 blur-3xl opacity-60" />
        <div className="absolute right-0 top-0 h-130 w-130 rounded-full bg-blue-100 blur-3xl opacity-70" />
      </div>
      ...
      <div className="mx-auto max-w-295 px-6">
        ...
        <div className="text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <PrimaryButton to="/about" variant="secondary">
              See how it works
            </PrimaryButton>
          </div>
        </div>
